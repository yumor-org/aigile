...
5. **AI**: Requirement Document（[docs/L1_requirements/](docs/L1_requirements/)）を起こす PR を発行する。
6. **人間**: PR をレビューしてマージすると、対応する Issue が Accepted-Closed として閉じられる。

フロー全体（Req → Spec → Arch のカスケード）・Specification / Architecture 以降の流れ・エスカレーション機構は [workflow.md](https://github.com/yumor-org/aigile/blob/main/docs/workflow.md) と [escalation.md](https://github.com/yumor-org/aigile/blob/main/docs/escalation.md) を参照してください。
